...
export default function Internships() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!payload.studentName?.trim()      || !payload.studentEmail?.trim() ||
        !payload.studentPhone?.trim()     || !payload.studentCollege?.trim() ||
        !payload.studentDegree?.trim()    || !payload.internshipTrack ||
        !payload.studentStatement?.trim()) {
      setStatus({ msg: "Please fill in all required fields.", type: "error" });
      return;
    }
  ...
  return (
    <section className="section">
      <div className="container">
          ...
          <div className={styles.grid}>
            ...
            {!internships?.length && (
              <p style={{ color: "var(--color-text-muted)" }}>
                No internship tracks available at the moment.
              </p>
            )}
          </div>
        )}
        ...
        {/* Application Form */}
        <div ref={formRef} id="applyForm" className={`form-card ${styles.formSection}`}>
          <h2 className={styles.formTitle}>Apply for an internship</h2>
          <p className={styles.formSub}>
            Fill in your details below. College students can apply here for any available internship track.
          </p>
          ...
          <form className={styles.form} onSubmit={handleSubmit} noValidate>
            <div className="form-grid">
              ...
              <div className="field">
                ...
                <input id="studentDegree" name="studentDegree" type="text" required
                  placeholder="B.Tech ECE, Diploma Mechanical, etc." />
              </div>
              <div className="field">
              ...
              <div className="field field-full">
                ...
                <input
                  ...
                  name="studentSkills"
                  type="text"
                  placeholder="Arduino, ROS, CAD, Python, C++, PCB, SolidWorks..."
                />
              </div>
              <div className="field field-full">
